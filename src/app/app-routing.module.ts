...
const routes: Routes = [
  {
    path: "admin", component: LayoutComponent, children: [
      ...
      { path: "authorize-menu", loadChildren: () => import("./admin/components/authroize-menu/authroize-menu.module").then(module => module.AuthroizeMenuModule), canActivate: [AuthGuard] },
